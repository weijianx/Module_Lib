...
void rs485_Init(void)
{
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(2))));
...
int main(void)
{
 ...
 usart_interrupt_enable(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), USART_INT_RBNE);
    ...
    while (1)
 {
  ...
  else if(T_H.Upload_persist[T_H.dev_num] != 0)
  {
...
void com_gpio_init(void)
{
    ...
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(10))));
}
...
void com_usart_init(void)
{
 ...
 flash_read_MultiBytes((((0x00 + 0x01) + 0x01) + 0x01), &(UserPara.Baudrate), 1);

    usart_deinit(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U));
    switch(UserPara.Baudrate)
 {
  case 01:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 2400U);
   break;

  case 02:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 4800U);
   break;

  case 03:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 9600U);
   break;

  case 04:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 19200U);
   break;

  case 05:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 38400U);
   break;

  case 06:
   usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 57600U);
   break;
