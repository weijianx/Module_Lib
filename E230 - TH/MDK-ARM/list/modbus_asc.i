...
uint8_t const SensorSoftVersion[10] = {0x09, 'S', 'V', '1', '.', '0', '.', '0', 'G', 'D'};
...
void MBASC_Fun10()
{
 ...
 SendBuf[SendLen++] = 0x10;
    ...
    if ((!((((ReadAdrL >= 0x30) && (ReadAdrL <= 0x4F)
            ...
            || (((ReadAdrH != UserPara.SlaveAddr_Temp) && (ReadAdrH != UserPara.SlaveAddr_Humi) ) && (ReadAdrH != 0x00)))
    {
        MBASC_SendErr((0x02));
        return;
    }
...
void MBASC_Fun2B(void)
{
 ...
 if(UserPara.SlaveAddr_Humi != UARTx_RXBuff[2] && UserPara.SlaveAddr_Temp != UARTx_RXBuff[2])
    {
...
void MBASC_Function(void)
{
  ...
  if(UARTx_RXBuff[0] <= 0x29 && UARTx_RXBuff[0] >= 0x26)
        ...
        else if(( (UserPara.SlaveAddr_Temp != UARTx_RXBuff[0]) && (UserPara.SlaveAddr_Humi != UARTx_RXBuff[0]) )&& (0x00 != UARTx_RXBuff[0]))
        {
            return;
        }
