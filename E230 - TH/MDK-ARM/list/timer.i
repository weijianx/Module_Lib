...
typedef struct
{
 ...
 uint8_t SlaveAddr_Temp;
    uint8_t SlaveAddr_Humi;
    uint8_t Baudrate;
    uint8_t Parity;
...
void timer_config(void)
{
 ...
 timer_deinit(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U));
    ...
    timer_init(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U),&timer_initpara);
# 50 "../BSP/Src/timer.c"
 timer_channel_input_struct_para_init(&timer_icinitpara);
 timer_icinitpara.icpolarity = ((uint16_t)0x0000U);
 timer_icinitpara.icselection = ((uint16_t)0x0001U);
 timer_icinitpara.icprescaler = ((uint16_t)0x0000U);
 timer_icinitpara.icfilter = 0x00;
 timer_input_capture_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint16_t)0x0000U), &timer_icinitpara);
 ...
 timer_icinitpara.icprescaler = ((uint16_t)0x0000U);
 timer_icinitpara.icfilter = 0x00;
 timer_input_capture_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint16_t)0x0001U), &timer_icinitpara);



    timer_auto_reload_shadow_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U));
 ...
 timer_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U));
...
void TIMER2_Init(void)
{
 timer_oc_parameter_struct timer_ocintpara;
    ...
    timer_deinit(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U));
    ...
    timer_initpara.clockdivision = ((uint16_t)(((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9)))) & ((uint32_t)(0) << 8U)));
    timer_initpara.repetitioncounter = 0;
    timer_init(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U),&timer_initpara);
# 110 "../BSP/Src/timer.c"
 nvic_irq_enable(TIMER14_IRQn, 2);

    timer_auto_reload_shadow_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U));


 timer_interrupt_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U), ((uint32_t)((uint32_t)0x01U<<(0))));
 timer_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U));
...
void TIMER14_IRQHandler(void)
{
 ...
 if(timer_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U), ((uint32_t)((uint32_t)0x01U<<(0)))))
 {
  timer_interrupt_flag_clear(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014000U), ((uint32_t)((uint32_t)0x01U<<(0))));
  Time_1s_flag = 1;
